"""Dev prototype: intent-conditioned COVER-ART channel.
Detect cover/artwork requests, encode the description with the SigLIP2 TEXT encoder,
compare it by cosine similarity with the provided 768-d image-siglip2 embeddings,
and measure GT recall. Compare with the current ctx1024 text pool on the SAME turns and with RRF fusion.

    CUDA_VISIBLE_DEVICES=0 python src/ablations/cover_channel.py
"""
